  ...
  return (
    <div className='px-4 py-6'>
      ...
      <Form method="POST" action="/order/new">
        <div className='mb-5 flex flex-col items gap-2 sm:flex-row sm:items-center'>
        ...
        <div  className='mb-5 flex flex-col gap-2 sm:flex-row sm:items-center'>
          ...
          {formsErrors?.phone && <p className='text-xs mt-2 text-red-700 bg-red-100 p-2 rounded-md'>{formsErrors.phone}</p>}
          </div>
        </div>
